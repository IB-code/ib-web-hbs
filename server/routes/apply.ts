        ...
        if (county === "Jefferson" || county === "Shelby" || county === "St. Clair" || county === "Blount" || county === "Walker" || county === "Chilton") {
            try {
                return send(
                    ...
                    `Dear ${name}, ${os.EOL} ${os.EOL} Thank you for submitting your application for Innovate Birmingham! To continue with the application process, you must complete a video interview here. You have 2 weeks from the date of your application to complete the interview. After completing the interview, please complete the questionnaire using this Survey link. These additional steps are vital to your application.${os.EOL} ${os.EOL} After you successfully complete the video interview, our Admissions team will review your application and follow up within 2 weeks.${os.EOL} ${os.EOL}  Please contact kayla@innovatebham.com if you have any questions during the application process. ${os.EOL} ${os.EOL} Sincerely, The Innovate Bham Team`,
                );
            } catch (error) {
                console.log(error);
                res.send(error);

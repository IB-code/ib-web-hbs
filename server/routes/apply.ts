        ...
        if (age >= 17) {
            if (county === "8: Jefferson" || county === "9: Shelby" || county === "10: St. Clair" || county === "11: Blount" || county === "12: Walker" || county === "13: Chilton") {
                return send(
                    ...
                    `Dear ${name}, ${os.EOL} ${os.EOL} Thank you for submitting your application for Innovate Birmingham! To continue with the application process, you must complete a video interview here: https://start.myinterview.com/innovate-birmingham/customer-service-interview. If your myInterview link is not working, please contact admissions@innovatebham.com You have 2 weeks from the date of your application to complete the interview. After completing the interview, please complete the questionnaire using this Survey link: https://uab.co1.qualtrics.com/jfe/form/SV_emopl7uwuzmbFA1. These additional steps are vital to your application.${os.EOL} ${os.EOL}After you successfully complete the video interview, our Admissions team will review your application and follow up within 2 weeks.${os.EOL} ${os.EOL}Please contact admissions@innovatebham.com if you have any questions during the application process. ${os.EOL} ${os.EOL}Sincerely,${os.EOL}The Innovate Bham Team`,
                );
            } else {
                return send(
                    "Innovate Birmingham <admissions@innovatebham.com>", // is this where im supposed to change the email?
